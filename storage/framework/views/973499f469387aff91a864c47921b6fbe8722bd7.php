...
<form action="<?php echo e(route('buku.update', $data->id)); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="col-md-12 d-flex align-items-stretch grid-margin">
              <div class="row flex-grow">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                      <h4 class="card-title">Edit Buku <b><?php echo e($data->judul); ?></b> </h4>
                      <form class="forms-sample">
                        <div class="form-group<?php echo e($errors->has('judul') ? ' has-error' : ''); ?>">
                            <label for="judul" class="col-md-4 control-label">Judul</label>
                            <div class="col-md-6">
                                <input id="judul" type="text" class="form-control" name="judul" value="<?php echo e($data->judul); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('npm') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="isbn" type="text" class="form-control" name="isbn" value="<?php echo e($data->isbn); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('pengarang') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="pengarang" type="text" class="form-control" name="pengarang" value="<?php echo e($data->pengarang); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('penerbit') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="penerbit" type="text" class="form-control" name="penerbit" value="<?php echo e($data->penerbit); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('tahun_terbit') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="tahun_terbit" type="number" maxlength="4" class="form-control" name="tahun_terbit" value="<?php echo e($data->tahun_terbit); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('jumlah_buku') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah_buku" type="number" maxlength="4" class="form-control" name="jumlah_buku" value="<?php echo e($data->jumlah_buku); ?>" required>
                        ...
                        <div class="form-group<?php echo e($errors->has('deskripsi') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-12">
                                <input id="deskripsi" type="text" class="form-control" name="deskripsi" value="<?php echo e($data->deskripsi); ?>" >
                        ...
                        <div class="form-group<?php echo e($errors->has('lokasi') ? ' has-error' : ''); ?>">
                            ...
                            <select class="form-control" name="lokasi" required="">
                                <option value="rak1" <?php echo e($data->lokasi === "rak1" ? "selected" : ""); ?>>Rak 1</option>
                                <option value="rak2" <?php echo e($data->lokasi === "rak2" ? "selected" : ""); ?>>Rak 2</option>
                                <option value="rak3" <?php echo e($data->lokasi === "rak3" ? "selected" : ""); ?>>Rak 3</option>
                            </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <img width="200" height="200" <?php if($data->cover): ?> src="<?php echo e(asset('images/buku/'.$data->cover)); ?>" <?php endif; ?> />
