...
<head>
  ...
  <title>PERPUSKU - UNIVERSITAS YUDHARTA</title>
  <!-- plugins:css -->
      ...
      <div class="main-panel">
        ...
        <footer class="footer">
          <div class="container-fluid clearfix">
            <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © <?php echo e(date('Y')); ?>

            <a href="https://gilacoding.com/" target="_blank">Team Abal-Abal</a>. All rights reserved.</span>
          </div>
        </footer>
        <!-- partial -->
      </div>
